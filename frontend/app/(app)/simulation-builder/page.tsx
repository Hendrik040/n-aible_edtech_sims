...
useEffect(() => {
 ...
 // Authentication + role guard - must be after all hooks
 // The (app) layout handles basic auth; this guards professor-only access
 useEffect(() => {
   if (!authLoading && !user) {
     router.push("/")
...
const handlePlaySimulation = async () => {
  ...
  // Navigate to chatbox
  window.open("/test-simulations", "_blank");
...
return (
   <div className="text-foreground">
     ...
     {/* Main content area - ml-20 provided by (app) layout */}
