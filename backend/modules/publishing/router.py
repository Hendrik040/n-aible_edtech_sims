...
from common.utils.rate_limiter import check_anonymous_review_rate_limit
from common.utils.auth import get_current_user, get_current_user_optional
...
async def create_scenario_review(
    ...
    from common.utils.rate_limiter import rate_limiter, ANONYMOUS_REVIEW_CONFIG
