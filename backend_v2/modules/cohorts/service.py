            ...
            for student in students:
                ...
                if StudentSimulationInstance:
                    ...
                    if existing_instance:
                        ...
                        # Deletion of the linked user_progress was handled by
                        # modules.simulation.repository.SimulationRepository,
                        # which has been removed from backend_v2. The re-assign
                        # flow proceeds without the cascade clean-up until the
                        # simulation runtime is rebuilt on the Claude Agent SDK.
                        if existing_instance.user_progress_id and UserProgress:
                            logger.warning(
                                "Skipping user_progress cleanup for instance %s: "
                                "simulation runtime not yet available in backend_v2",
                                existing_instance.unique_id,
                            )
